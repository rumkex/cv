...
\addtofrontsidebar{
    ...
    \aboutme{
    Pythonista with a knack for studying. I also have significant experience with C\#, as well as moderate C/C++ knowledge. Looking for a Python developer position to solve challenging and new problems. 
    }
	...
	\profilesection{Hard Skills}
		...
		\skill[1.5em]{\faCompress}{Web Development}
		...
		\skill{\faSync}{DevOps}
		\skill{\faSitemap}{System Administration (Linux)}
...
\begin{cvtable}[3]
	...
	\cvitem{2018 -- currently}{Moscow State University}{Junior Researcher}{
	    Analyzing heaps of GNSS data. Writing bits and pieces of scientific software for data analysis.
	    \\
    	\textit{Technologies used: Numpy/Scipy/Matplotlib}
	}
\end{cvtable}
